...
export async function extractImage(_bytes: Uint8Array, hint = ""): Promise<ExtractResult> {
  const t = hint || "image";
  return { summary: `image: ${t}`, memories: [{ text: `Saved an image: ${t}`, tags: ["image"], when: "", confidence: 0.5 }] };
}
