...
module teams::team {
  ...
  public struct MemberRoleChanged has copy, drop {
    team_id: ID,
    member: address,
    role: u8,
    timestamp_ms: u64,
  ...
  public struct TeamReactivated has copy, drop {
    team_id: ID,
    timestamp_ms: u64,
  }
  ...
  public fun set_feed_blob(
    ...
    team.feed_blob = blob;
    team.updated_at_ms = now_ms;
    event::emit(TeamFeedSet {
      team_id: object::id(team),
      timestamp_ms: now_ms,
    });
  }

  public fun set_memory_blob(
    team: &mut Team,
    blob: String,
    clock: &Clock,
    ctx: &TxContext,
  ...
  public fun is_member(team: &Team, who: address): bool {
    team.members.contains(&who)
  }
  ...
  public fun member_role(team: &Team, who: address): Option<u8> {
    team.member_roles.try_get(&who)
  }

  public fun member_name(team: &Team, who: address): Option<String> {
    team.member_names.try_get(&who)
  }
