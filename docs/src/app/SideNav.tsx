...
function Wordmark({ isOverview }: { isOverview: boolean }) {
  return (
    <div className="side-nav-logo">
      ...
      >
        <span className="side-nav-wordmark">Cortex</span>
      </Link>
    </div>
  );
}
...
export function SideNav() {
  ...
  const links: ({ href: string; label: string; badge?: string; items?: { id: string; text: string }[] } | { section: string })[] = [
    ...
    { href: "/install", label: "Install" },
    {
      ...
      label: "Concepts",
      items: [
        { id: 'memory-not-chat', text: 'Memory, Not Chat' },
        { id: 'artifact-types', text: 'Artifact Types' },
        { id: 'local-first', text: 'Local-First' },
        { id: 'ingestion', text: 'Ingestion' },
        { id: 'recall', text: 'Recall' },
        { id: 'consolidation', text: 'Consolidation' },
        { id: 'verification', text: 'Verification' },
        { id: 'multi-agent', text: 'Multi-Agent State' },
      ],
    },
    {
      href: "/schema",
      ...
      items: [
        ...
        { id: 'extraction', text: 'Extraction' },
        { id: 'memory-diff', text: 'MemoryDiff' },
        { id: 'namespace-manifest', text: 'NamespaceManifest' },
    ...
    { section: "Connectors" },
    {
      ...
      items: [
        ...
        { id: 'connect-a-client', text: 'Connect a Client' },
        { id: 'authorize', text: 'Authorize' },
        { id: 'tools', text: 'Tools' },
    ...
    },
    {
      ...
      items: [
        { id: 'overview', text: 'Overview' },
        { id: 'cortex-class', text: 'Cortex Class' },
        { id: 'ingest', text: 'Ingest' },
        { id: 'recall', text: 'Recall' },
        { id: 'consolidate', text: 'Consolidate' },
        { id: 'views', text: 'Views' },
    ...
    },
    {
      ...
      items: [
        { id: 'overview', text: 'Overview' },
        { id: 'web-fetch', text: 'Web Fetch' },
        { id: 'notify', text: 'Notify' },
        { id: 'export', text: 'Export' },
        { id: 'agent-bus', text: 'Agent Bus' },
      ],
    },
    { section: "Resources" },
