        ...
        <div className="hero-demo-terminal-content">
          <div className="hero-demo-terminal-welcome">
            ...
            <svg viewBox="0 0 240 76" fill="none" style={{ width: '100%', height: 'auto', display: 'block' }}>
              ...
              <text x="160" y="16" fill="rgba(0,0,0,0.7)" fontSize="9" fontFamily="var(--font-docs)" fontWeight="500">Claude Code</text>
              <text x="160" y="26" fill="rgba(0,0,0,0.4)" fontSize="7" fontFamily="var(--font-docs)">v2.1.14</text>

              {/* Welcome text */}
              <text x="78" y="20" fill="rgba(0,0,0,0.6)" fontSize="8" fontFamily="var(--font-docs)" textAnchor="middle">Welcome back Benji!</text>
              ...
              {/* Bottom info */}
              <text x="78" y="62" fill="rgba(0,0,0,0.4)" fontSize="7" fontFamily="var(--font-docs)" textAnchor="middle">Opus 4.5 · ~/Code/agentation</text>
            </svg>
          </div>
          {terminalText}
          <span style={{ opacity: 0.4 }}>█</span>
