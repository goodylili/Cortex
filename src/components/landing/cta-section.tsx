...
const HEADLINE = "Your memory, gently kept. Always there, always yours";
        ...
        <div className="max-w-3xl">
          ...
          <Reveal>
            <p className="mt-6 max-w-2xl text-balance text-base leading-relaxed text-ink/70 md:text-lg">
              Start using Cortex free. No credit card required. Your memory is
              yours to keep, on infrastructure you control.
            </p>
          </Reveal>
