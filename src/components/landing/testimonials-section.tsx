...
const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    id: 2,
    quote:
      "The local-first approach was what sealed it for me. My memory stays on my device, encrypted, and mine alone. Finally, an AI tool that respects what I'm building.",
  ...
  },
  {
    id: 6,
    quote:
      "Encrypted sharing that just works. I sent research to a collaborator by name, they opened it on their device, and our conversation stayed private and grounded in our actual work.",
    author: "Morgan Lee",
    role: "Academic",
    avatar:
